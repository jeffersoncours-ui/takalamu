...
function PageHeader({ title, sub }: { title: string; sub?: string }) {
  return (
    <div className="text-center mb-8">
      ...
      <h1 className="leading-tight mb-2" style={{ fontFamily: "var(--font-barlow)", fontWeight: 700, fontSize: 28, color: "#1C1A17" }}>
        {title}
      </h1>
...
function SuccessAuto({ checkoutUrl, orderRef }: { checkoutUrl: string; orderRef: string }) {
  return (
    <div className="text-center py-10">
      ...
      <h2 className="font-bold mb-3" style={{ fontFamily: "var(--font-barlow)", fontSize: 24, color: "#1C1A17" }}>
        Commande créée !
      </h2>
