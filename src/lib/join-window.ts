...
// Le lien Google Meet devient disponible JOIN_OPEN_MIN minutes AVANT le cours
...
// le lien du cours (`zoom_link` en base) est aujourd'hui livré dans le SSR. Pour
// couper réellement l'accès hors fenêtre, il faudra servir le lien via une
// RPC/route gardée temporellement.
// TODO Phase 5+ : livraison du lien de visio côté serveur, fenêtrée.
